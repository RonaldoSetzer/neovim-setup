...
utils.keymap("n", "<Leader>cc", "<Cmd>cclose<CR>", "• Quickfix: Close quickfix")
utils.keymap("n", "<Leader>co", "<Cmd>copen<CR>", "• Quickfix: Open quickfix")
utils.keymap("n", "<leader>cn", "<Cmd>cnext<CR>", "• Quickfix: Go to next item")
utils.keymap("n", "<leader>cp", "<Cmd>cprev<CR>", "• Quickfix: Go to previous item")
