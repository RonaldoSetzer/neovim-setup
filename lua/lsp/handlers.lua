...
local function lsp_keymaps(bufnr)
  ...
  -- LSP SAGA
  vim.api.nvim_buf_set_keymap(bufnr, "n", "Kf", "<cmd>lua require('lspsaga.provider').lsp_finder()<CR>", opts)
  vim.api.nvim_buf_set_keymap(bufnr, "n", "K", "<cmd>lua require('lspsaga.hover').render_hover_doc()<CR>", opts)
  vim.api.nvim_buf_set_keymap(bufnr, "n", "Kd", "<cmd>lua require'lspsaga.diagnostic'.show_line_diagnostics()<CR>", opts)
  vim.api.nvim_buf_set_keymap(bufnr, "n", "<leader>ca", "<cmd>lua require'lspsaga.codeaction'.code_action()<CR>", opts)
  vim.api.nvim_buf_set_keymap(bufnr, "n", "<leader>rr", "<cmd>lua require'lspsaga.rename'.rename()<CR>", opts)
